...
class Message(object):
    ...
    def shift_char(self, char, shift):
        ...
        '''
        initial_num = ord(char) - 32
        final_num = (initial_num + shift)
        if (final_num < 0):
            final_num += 95
        final_num = final_num % 95 
        final_num += 32
        return chr(final_num)
...
class PlaintextMessage(Message):
    def __init__(self, input_text, pad=None):
        ...
        if (pad == None):
            ...
            self.pad = pad
        self.encrypted_message_text = super().apply_pad(self.pad)
    ...
    def generate_pad(self):
        ...
        pad = []
        for i in range(len(self.message_text)):
            pad.append(random.randint(0, 94))
        return pad
...
class EncryptedMessage(Message):
    ...
    def decrypt_message(self, pad):
        ...
        for i in pad:
            new_pad.append(0-i)
        plaintext = super().apply_pad(new_pad)
        return plaintext
    ...
    def decrypt_message_try_pads(self, pads):
        ...
        plaintext = ""
        for pad in pads:
            decrypt = self.decrypt_message(pad)
            wordlist = decrypt.split(' ')
            num_words = 0
            ...
            if num_words > max_words:
                ...
                plaintext = decrypt
        if max_words == 0:
            return(pads[0], self.decrypt_message(pads[0]))
        else:
            return (best_pad, plaintext)
...
def decode_story():
    ...
    return story.decrypt_message_try_pads(get_story_pads())
...
tester = PlaintextMessage("hey how are you")
